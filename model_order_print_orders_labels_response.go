...
// DownloadUrl returns a boolean if a field has been set.
func (o *OrderPrintOrdersLabelsResponse) DownloadUrl() bool {
	if o != nil && !IsNil(o.DownloadUrl) {
		return true
	}
...
// FailedOrders returns a boolean if a field has been set.
func (o *OrderPrintOrdersLabelsResponse) FailedOrders() bool {
	if o != nil && !IsNil(o.FailedOrders) {
		return true
	}
