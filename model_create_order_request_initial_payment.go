...
func (o *CreateOrderRequestInitialPayment) AdditionalInfo() bool {
	if o != nil && !IsNil(o.AdditionalInfo) {
		return true
	}
...
func (o *CreateOrderRequestInitialPayment) CcInfo() bool {
	if o != nil && !IsNil(o.CcInfo) {
		return true
	}
...
// Transaction returns a boolean if a field has been set.
func (o *CreateOrderRequestInitialPayment) Transaction() bool {
	if o != nil && !IsNil(o.Transaction) {
		return true
	}
