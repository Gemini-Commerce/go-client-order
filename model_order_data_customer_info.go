...
func (o *OrderDataCustomerInfo) Grn() bool {
	if o != nil && !IsNil(o.Grn) {
		return true
	}
...
// Phone returns a boolean if a field has been set.
func (o *OrderDataCustomerInfo) Phone() bool {
	if o != nil && !IsNil(o.Phone) {
		return true
	}
...
// Segment returns a boolean if a field has been set.
func (o *OrderDataCustomerInfo) Segment() bool {
	if o != nil && !IsNil(o.Segment) {
		return true
	}
...
// Data returns a boolean if a field has been set.
func (o *OrderDataCustomerInfo) Data() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// CertifiedEmail returns a boolean if a field has been set.
func (o *OrderDataCustomerInfo) CertifiedEmail() bool {
	if o != nil && !IsNil(o.CertifiedEmail) {
		return true
	}
...
// TaxCode returns a boolean if a field has been set.
func (o *OrderDataCustomerInfo) TaxCode() bool {
	if o != nil && !IsNil(o.TaxCode) {
		return true
	}
...
// SdiCode returns a boolean if a field has been set.
func (o *OrderDataCustomerInfo) SdiCode() bool {
	if o != nil && !IsNil(o.SdiCode) {
		return true
	}
...
// FiscalCode returns a boolean if a field has been set.
func (o *OrderDataCustomerInfo) FiscalCode() bool {
	if o != nil && !IsNil(o.FiscalCode) {
		return true
	}
...
// CompanyName returns a boolean if a field has been set.
func (o *OrderDataCustomerInfo) CompanyName() bool {
	if o != nil && !IsNil(o.CompanyName) {
		return true
	}
...
func (o *OrderDataCustomerInfo) AgentGrn() bool {
	if o != nil && !IsNil(o.AgentGrn) {
		return true
	}
