...
func (o *OrderShipment) CreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *OrderShipment) UpdatedAt() bool {
	if o != nil && !IsNil(o.UpdatedAt) {
		return true
	}
...
// OrderId returns a boolean if a field has been set.
func (o *OrderShipment) OrderId() bool {
	if o != nil && !IsNil(o.OrderId) {
		return true
	}
...
func (o *OrderShipment) Status() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *OrderShipment) Items() bool {
	if o != nil && !IsNil(o.Items) {
		return true
	}
...
// Address returns a boolean if a field has been set.
func (o *OrderShipment) Address() bool {
	if o != nil && !IsNil(o.Address) {
		return true
	}
...
func (o *OrderShipment) FromAddress() bool {
	if o != nil && !IsNil(o.FromAddress) {
		return true
	}
...
func (o *OrderShipment) ReturnAddress() bool {
	if o != nil && !IsNil(o.ReturnAddress) {
		return true
	}
...
func (o *OrderShipment) Tracking() bool {
	if o != nil && !IsNil(o.Tracking) {
		return true
	}
...
func (o *OrderShipment) ReturnTracking() bool {
	if o != nil && !IsNil(o.ReturnTracking) {
		return true
	}
