...
func (o *ProductConfigurationStepOption) Id() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ProductConfigurationStepOption) Grn() bool {
	if o != nil && !IsNil(o.Grn) {
		return true
	}
...
func (o *ProductConfigurationStepOption) Label() bool {
	if o != nil && !IsNil(o.Label) {
		return true
	}
...
// PriceVariation returns a boolean if a field has been set.
func (o *ProductConfigurationStepOption) PriceVariation() bool {
	if o != nil && !IsNil(o.PriceVariation) {
		return true
	}
...
// Image returns a boolean if a field has been set.
func (o *ProductConfigurationStepOption) Image() bool {
	if o != nil && !IsNil(o.Image) {
		return true
	}
...
// Quantity returns a boolean if a field has been set.
func (o *ProductConfigurationStepOption) Quantity() bool {
	if o != nil && !IsNil(o.Quantity) {
		return true
	}
