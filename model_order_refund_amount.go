...
func NewOrderRefundAmount() *OrderRefundAmount {
	...
	var code OrderRefundAmountCode = UNKNOWN
	this.Code = &code
	return &this
}
...
func (o *OrderRefundAmount) Code() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
// Value returns a boolean if a field has been set.
func (o *OrderRefundAmount) Value() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
