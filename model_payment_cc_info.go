...
// Approval returns a boolean if a field has been set.
func (o *PaymentCcInfo) Approval() bool {
	if o != nil && !IsNil(o.Approval) {
		return true
	}
...
// ExpMonth returns a boolean if a field has been set.
func (o *PaymentCcInfo) ExpMonth() bool {
	if o != nil && !IsNil(o.ExpMonth) {
		return true
	}
...
// ExpYear returns a boolean if a field has been set.
func (o *PaymentCcInfo) ExpYear() bool {
	if o != nil && !IsNil(o.ExpYear) {
		return true
	}
...
// Last4 returns a boolean if a field has been set.
func (o *PaymentCcInfo) Last4() bool {
	if o != nil && !IsNil(o.Last4) {
		return true
	}
...
// NumberEnc returns a boolean if a field has been set.
func (o *PaymentCcInfo) NumberEnc() bool {
	if o != nil && !IsNil(o.NumberEnc) {
		return true
	}
...
// Owner returns a boolean if a field has been set.
func (o *PaymentCcInfo) Owner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
// AvsStatus returns a boolean if a field has been set.
func (o *PaymentCcInfo) AvsStatus() bool {
	if o != nil && !IsNil(o.AvsStatus) {
		return true
	}
...
func (o *PaymentCcInfo) Type() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
