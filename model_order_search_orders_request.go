...
// SearchQuery returns a boolean if a field has been set.
func (o *OrderSearchOrdersRequest) SearchQuery() bool {
	if o != nil && !IsNil(o.SearchQuery) {
		return true
	}
...
func (o *OrderSearchOrdersRequest) PageSize() bool {
	if o != nil && !IsNil(o.PageSize) {
		return true
	}
...
func (o *OrderSearchOrdersRequest) PageToken() bool {
	if o != nil && !IsNil(o.PageToken) {
		return true
	}
...
func (o *OrderSearchOrdersRequest) OrderBy() bool {
	if o != nil && !IsNil(o.OrderBy) {
		return true
	}
...
func (o *OrderSearchOrdersRequest) StatusFilter() bool {
	if o != nil && !IsNil(o.StatusFilter) {
		return true
	}
...
// FromDate returns a boolean if a field has been set.
func (o *OrderSearchOrdersRequest) FromDate() bool {
	if o != nil && !IsNil(o.FromDate) {
		return true
	}
...
// ToDate returns a boolean if a field has been set.
func (o *OrderSearchOrdersRequest) ToDate() bool {
	if o != nil && !IsNil(o.ToDate) {
		return true
	}
...
// PaymentFilter returns a boolean if a field has been set.
func (o *OrderSearchOrdersRequest) PaymentFilter() bool {
	if o != nil && !IsNil(o.PaymentFilter) {
		return true
	}
...
// AgentGrn returns a boolean if a field has been set.
func (o *OrderSearchOrdersRequest) AgentGrn() bool {
	if o != nil && !IsNil(o.AgentGrn) {
		return true
	}
...
// UpdatedAtFrom returns a boolean if a field has been set.
func (o *OrderSearchOrdersRequest) UpdatedAtFrom() bool {
	if o != nil && !IsNil(o.UpdatedAtFrom) {
		return true
	}
...
// UpdatedAtTo returns a boolean if a field has been set.
func (o *OrderSearchOrdersRequest) UpdatedAtTo() bool {
	if o != nil && !IsNil(o.UpdatedAtTo) {
		return true
	}
...
func (o *OrderSearchOrdersRequest) OnHold() bool {
	if o != nil && !IsNil(o.OnHold) {
		return true
	}
