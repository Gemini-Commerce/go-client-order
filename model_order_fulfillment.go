...
func (o *OrderFulfillment) CreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *OrderFulfillment) UpdatedAt() bool {
	if o != nil && !IsNil(o.UpdatedAt) {
		return true
	}
...
func (o *OrderFulfillment) OrderId() bool {
	if o != nil && !IsNil(o.OrderId) {
		return true
	}
...
func (o *OrderFulfillment) Id() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *OrderFulfillment) Status() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *OrderFulfillment) Items() bool {
	if o != nil && !IsNil(o.Items) {
		return true
	}
