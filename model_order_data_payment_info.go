...
func (o *OrderDataPaymentInfo) AdditionalInfo() bool {
	if o != nil && !IsNil(o.AdditionalInfo) {
		return true
	}
...
func (o *OrderDataPaymentInfo) Fee() bool {
	if o != nil && !IsNil(o.Fee) {
		return true
	}
...
func (o *OrderDataPaymentInfo) VatAmount() bool {
	if o != nil && !IsNil(o.VatAmount) {
		return true
	}
...
func (o *OrderDataPaymentInfo) VatPercentage() bool {
	if o != nil && !IsNil(o.VatPercentage) {
		return true
	}
...
func (o *OrderDataPaymentInfo) VatInaccurate() bool {
	if o != nil && !IsNil(o.VatInaccurate) {
		return true
	}
...
func (o *OrderDataPaymentInfo) VatCalculated() bool {
	if o != nil && !IsNil(o.VatCalculated) {
		return true
	}
...
func (o *OrderDataPaymentInfo) Title() bool {
	if o != nil && !IsNil(o.Title) {
		return true
	}
...
func (o *OrderDataPaymentInfo) Label() bool {
	if o != nil && !IsNil(o.Label) {
		return true
	}
