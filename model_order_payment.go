...
func (o *OrderPayment) OrderId() bool {
	if o != nil && !IsNil(o.OrderId) {
		return true
	}
...
func (o *OrderPayment) AdditionalInfo() bool {
	if o != nil && !IsNil(o.AdditionalInfo) {
		return true
	}
...
func (o *OrderPayment) Amounts() bool {
	if o != nil && !IsNil(o.Amounts) {
		return true
	}
...
func (o *OrderPayment) CcInfo() bool {
	if o != nil && !IsNil(o.CcInfo) {
		return true
	}
...
// Transactions returns a boolean if a field has been set.
func (o *OrderPayment) Transactions() bool {
	if o != nil && !IsNil(o.Transactions) {
		return true
	}
