...
// Orders returns a boolean if a field has been set.
func (o *OrderListOrdersResponse) Orders() bool {
	if o != nil && !IsNil(o.Orders) {
		return true
	}
...
// NextPageToken returns a boolean if a field has been set.
func (o *OrderListOrdersResponse) NextPageToken() bool {
	if o != nil && !IsNil(o.NextPageToken) {
		return true
	}
