...
func (o *OrderDataDocument) Code() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *OrderDataDocument) Label() bool {
	if o != nil && !IsNil(o.Label) {
		return true
	}
...
// AssetGrn returns a boolean if a field has been set.
func (o *OrderDataDocument) AssetGrn() bool {
	if o != nil && !IsNil(o.AssetGrn) {
		return true
	}
...
func (o *OrderDataDocument) Url() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *OrderDataDocument) InsertedAt() bool {
	if o != nil && !IsNil(o.InsertedAt) {
		return true
	}
