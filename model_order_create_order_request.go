...
func (o *OrderCreateOrderRequest) Channel() bool {
	if o != nil && !IsNil(o.Channel) {
		return true
	}
...
func (o *OrderCreateOrderRequest) PaymentsInfo() bool {
	if o != nil && !IsNil(o.PaymentsInfo) {
		return true
	}
...
func (o *OrderCreateOrderRequest) ShipmentsInfo() bool {
	if o != nil && !IsNil(o.ShipmentsInfo) {
		return true
	}
...
func (o *OrderCreateOrderRequest) Promotions() bool {
	if o != nil && !IsNil(o.Promotions) {
		return true
	}
...
func (o *OrderCreateOrderRequest) Payments() bool {
	if o != nil && !IsNil(o.Payments) {
		return true
	}
...
func (o *OrderCreateOrderRequest) CartGrn() bool {
	if o != nil && !IsNil(o.CartGrn) {
		return true
	}
...
func (o *OrderCreateOrderRequest) OnHold() bool {
	if o != nil && !IsNil(o.OnHold) {
		return true
	}
...
func (o *OrderCreateOrderRequest) Notes() bool {
	if o != nil && !IsNil(o.Notes) {
		return true
	}
