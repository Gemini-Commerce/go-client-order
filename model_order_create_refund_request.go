...
func (o *OrderCreateRefundRequest) Items() bool {
	if o != nil && !IsNil(o.Items) {
		return true
	}
...
// Note returns a boolean if a field has been set.
func (o *OrderCreateRefundRequest) Note() bool {
	if o != nil && !IsNil(o.Note) {
		return true
	}
...
func (o *OrderCreateRefundRequest) AdditionalInfo() bool {
	if o != nil && !IsNil(o.AdditionalInfo) {
		return true
	}
...
func (o *OrderCreateRefundRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varOrderCreateRefundRequest)
