...
// Message returns a boolean if a field has been set.
func (o *RpcStatus) Message() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
// Details returns a boolean if a field has been set.
func (o *RpcStatus) Details() bool {
	if o != nil && !IsNil(o.Details) {
		return true
	}
