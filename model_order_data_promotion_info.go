...
func (o *OrderDataPromotionInfo) PromotionGrn() bool {
	if o != nil && !IsNil(o.PromotionGrn) {
		return true
	}
...
func (o *OrderDataPromotionInfo) AdditionalInfo() bool {
	if o != nil && !IsNil(o.AdditionalInfo) {
		return true
	}
...
func (o *OrderDataPromotionInfo) Description() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
// CouponCode returns a boolean if a field has been set.
func (o *OrderDataPromotionInfo) CouponCode() bool {
	if o != nil && !IsNil(o.CouponCode) {
		return true
	}
...
func (o *OrderDataPromotionInfo) VatAmount() bool {
	if o != nil && !IsNil(o.VatAmount) {
		return true
	}
...
func (o *OrderDataPromotionInfo) VatPercentage() bool {
	if o != nil && !IsNil(o.VatPercentage) {
		return true
	}
...
func (o *OrderDataPromotionInfo) VatInaccurate() bool {
	if o != nil && !IsNil(o.VatInaccurate) {
		return true
	}
...
func (o *OrderDataPromotionInfo) VatCalculated() bool {
	if o != nil && !IsNil(o.VatCalculated) {
		return true
	}
