...
// Units returns a boolean if a field has been set.
func (o *OrderMoney) Units() bool {
	if o != nil && !IsNil(o.Units) {
		return true
	}
...
// Micros returns a boolean if a field has been set.
func (o *OrderMoney) Micros() bool {
	if o != nil && !IsNil(o.Micros) {
		return true
	}
