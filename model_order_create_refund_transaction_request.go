...
func NewOrderCreateRefundTransactionRequest(tenantId string, refundId string) *OrderCreateRefundTransactionRequest {
...
// ParentTransactionId returns a boolean if a field has been set.
func (o *OrderCreateRefundTransactionRequest) ParentTransactionId() bool {
	if o != nil && !IsNil(o.ParentTransactionId) {
		return true
	}
...
func (o *OrderCreateRefundTransactionRequest) Type() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *OrderCreateRefundTransactionRequest) AdditionalInfo() bool {
	if o != nil && !IsNil(o.AdditionalInfo) {
		return true
	}
...
func (o *OrderCreateRefundTransactionRequest) UnmarshalJSON(data []byte) (err error) {
