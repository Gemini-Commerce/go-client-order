...
// Payload returns a boolean if a field has been set.
func (o *OrderUpdateOrderRequest) Payload() bool {
	if o != nil && !IsNil(o.Payload) {
		return true
	}
...
// FieldMask returns a boolean if a field has been set.
func (o *OrderUpdateOrderRequest) FieldMask() bool {
	if o != nil && !IsNil(o.FieldMask) {
		return true
	}
