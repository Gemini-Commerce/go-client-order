...
// Inventory returns a boolean if a field has been set.
func (o *CancelOrderRequestBehaviorOptions) Inventory() bool {
	if o != nil && !IsNil(o.Inventory) {
		return true
	}
...
// Payment returns a boolean if a field has been set.
func (o *CancelOrderRequestBehaviorOptions) Payment() bool {
	if o != nil && !IsNil(o.Payment) {
		return true
	}
