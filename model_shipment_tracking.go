...
// CarrierCode returns a boolean if a field has been set.
func (o *ShipmentTracking) CarrierCode() bool {
	if o != nil && !IsNil(o.CarrierCode) {
		return true
	}
...
// CarrierTitle returns a boolean if a field has been set.
func (o *ShipmentTracking) CarrierTitle() bool {
	if o != nil && !IsNil(o.CarrierTitle) {
		return true
	}
...
func (o *ShipmentTracking) Url() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *ShipmentTracking) Number() bool {
	if o != nil && !IsNil(o.Number) {
		return true
	}
...
// LabelUrl returns a boolean if a field has been set.
func (o *ShipmentTracking) LabelUrl() bool {
	if o != nil && !IsNil(o.LabelUrl) {
		return true
	}
