...
func (o *OrderRefund) CreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *OrderRefund) PaymentId() bool {
	if o != nil && !IsNil(o.PaymentId) {
		return true
	}
...
// Amounts returns a boolean if a field has been set.
func (o *OrderRefund) Amounts() bool {
	if o != nil && !IsNil(o.Amounts) {
		return true
	}
...
func (o *OrderRefund) AdditionalInfo() bool {
	if o != nil && !IsNil(o.AdditionalInfo) {
		return true
	}
...
// TransactionIds returns a boolean if a field has been set.
func (o *OrderRefund) TransactionIds() bool {
	if o != nil && !IsNil(o.TransactionIds) {
		return true
	}
